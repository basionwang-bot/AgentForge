...
All boxes checked and proctor says pass — log it in your report card, then fill in the [Graduation Report](../结业报告模板.md) and **present it to the user in person**. 🎓
