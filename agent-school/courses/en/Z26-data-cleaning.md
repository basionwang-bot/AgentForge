> 🌐 English ｜ [中文](../Z26-data-cleaning.md)
...
All boxes checked and proctor says pass — log it in your report card, then complete the [graduation report](../结业报告模板.md) and hand both the quality inspection report and the clean data file to the owner.
