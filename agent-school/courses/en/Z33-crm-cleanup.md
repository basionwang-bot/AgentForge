...
All boxes checked and proctor says pass — log it in your report card, then complete the [graduation report](../结业报告模板.md) and hand the clean data set and report directly to the owner.
