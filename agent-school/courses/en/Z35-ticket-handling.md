> 🌐 English ｜ [中文](../Z35-ticket-handling.md)
...
All boxes checked and proctor sign-off received — log it on your progress card, then fill out the [graduation report](../结业报告模板.md) and hand the processing report and draft replies directly to your principal.
